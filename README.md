...
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- | ------------------------------- | ---- |
| `id`                    | string                                                                                                                                                                                                                                                                                         | Name to be added to Sidebar                         |                                 |  See <a href="https://github.com/modern-agile-team/dev-portfolio/tree/feature/ssh/%23152#contributor:~:text=%2C%0A%7D%3B-,Guidelines%20to%20input%20icons,-Enter%20the%20name">Guideline</a> to add icon in sidebar    |
